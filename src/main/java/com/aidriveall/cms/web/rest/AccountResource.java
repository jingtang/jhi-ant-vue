...
import com.aidriveall.cms.web.rest.errors.*;
import com.aidriveall.cms.web.rest.vm.KeyAndPasswordVM;
import com.aidriveall.cms.web.rest.vm.ManagedUserVM;
...
public class AccountResource {
    ...
    public void updateImageUrl(String imageUrl) {
        ...
        userService.updateUser(user.get().getFirstName(), user.get().getLastName(), user.get().getEmail(),
            user.get().getLangKey(), imageUrl);
    }
