...
import com.aidriveall.cms.web.rest.vm.LoginVM;
...
public class UserJWTController {
    ...
    public ResponseEntity<JWTToken> authorize(@Valid @RequestBody LoginVM loginVM) {
        ...
        String jwt = tokenProvider.createTokenWithUserId(authentication, rememberMe, SecurityUtils.getCurrentUserId().orElse(null));
