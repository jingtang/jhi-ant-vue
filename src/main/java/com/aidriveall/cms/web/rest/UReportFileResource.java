...
/**
 * REST controller for managing {@link com.aidriveall.cms.domain.UReportFile}.
 */
@RestController
@RequestMapping("/api")
public class UReportFileResource {
    ...
    public UReportFileResource(UReportFileService uReportFileService, UReportFileQueryService uReportFileQueryService) {
    ...
    /**
     * {@code PUT  /u-report-files} : Updates an existing uReportFile.
     *
     ...
     * @throws URISyntaxException if the Location URI syntax is incorrect.
     */
    @PutMapping("/u-report-files")
    public ResponseEntity<UReportFileDTO> updateUReportFile(@RequestBody UReportFileDTO uReportFileDTO) throws URISyntaxException {
        log.debug("REST request to update UReportFile : {}", uReportFileDTO);
        if (uReportFileDTO.getId() == null) {
    ...
    public ResponseEntity<List<UReportFileDTO>> getAllUReportFiles(UReportFileCriteria criteria, Pageable pageable, @RequestParam(value = "listModelName", required = false) String listModelName) {
        log.debug("REST request to get UReportFiles by criteria: {}", criteria);
        Page<UReportFileDTO> page;
        if (listModelName != null) {
            page = uReportFileQueryService.selectByCustomEntity(listModelName, criteria,null, pageable);
        } else {
    ...
    */
    ...
    public ResponseEntity<Void> exportToExcel() throws IOException {
        ...
        Workbook workbook = ExcelExportUtil.exportExcel(new ExportParams("计算机一班学生","学生"),
            UReportFileDTO.class, page.getContent());
    ...
    */
    ...
    public ResponseEntity<UReportFileDTO> updateUReportFileBySpecifiedFields(@RequestBody UReportFileDTOAndSpecifiedFields uReportFileDTOAndSpecifiedFields) throws URISyntaxException {
    ...
    public ResponseEntity<UReportFileDTO> updateUReportFileBySpecifiedField(@RequestBody UReportFileDTOAndSpecifiedFields uReportFileDTOAndSpecifiedFields, UReportFileCriteria criteria) throws URISyntaxException {
        log.debug("REST request to update UReportFile : {}", uReportFileDTOAndSpecifiedFields);
        UReportFileDTO uReportFileDTO = uReportFileDTOAndSpecifiedFields.getUReportFile();
