...
@Component
export default class ProcessEntityRelationComponent extends mixins(Vue2Filters.mixin, AlertMixin) {
  ...
  public loadAll(): void {
    ...
    const paginationQuery = {
      listModelName: 'ProcessEntityRelation',
  ...
  public editEntity(row: IProcessEntityRelation): void {
