<template>
    <a-card :bordered="false">
        ...
        >
            <jhi-flowable-task-update :update-form-tag="updateFormTag" :processEntityId="processEntityId" :formJsonData="formJsonData" :taskId="taskId" :processInstanceId="processInstanceId" @closeModal="closeTaskUpdate"></jhi-flowable-task-update>
        </a-modal>
    </a-card>
</template>

<script lang="ts" src="./flowable-task.component.ts">
</script>
<style>
