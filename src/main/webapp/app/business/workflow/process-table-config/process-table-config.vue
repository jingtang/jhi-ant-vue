        ...
        <a-row :gutter="16">
            ...
            >
                ...
                <template slot-scope="{row, column}" slot="recordAction">
                    ...
                    <a-tooltip placement="top" title="流程设计">
                        <a-button type="primary" shape="circle" size="small" @click="designProcess(row)">
...
<script lang="ts" src="./process-table-config.component.ts">
</script>
<style>
