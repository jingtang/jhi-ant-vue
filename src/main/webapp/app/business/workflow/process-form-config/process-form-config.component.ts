...
@Component
export default class ProcessFormConfigComponent extends mixins(JhiDataUtils, Vue2Filters.mixin, AlertMixin) {
  ...
  public loadAll(): void {
    ...
    const paginationQuery = {
      listModelName: 'ProcessFormConfig',
  ...
  public editEntity(row: IProcessFormConfig): void {
