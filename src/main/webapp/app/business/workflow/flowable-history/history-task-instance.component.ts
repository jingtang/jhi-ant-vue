...
import HistoryTaskInstanceService from './history-task-instance.service';
...
@Component
export default class HistoryTaskInstanceComponent extends mixins(JhiDataUtils, Vue2Filters.mixin, AlertMixin) {
  @Inject('historyTaskInstanceService') private historyTaskInstanceService: () => HistoryTaskInstanceService;
  ...
  public loadAll(): void {
    ...
    this.historyTaskInstanceService()
  ...
  getCommonTableData() {
    this.xGridColumns = [
      { field: 'id', title: 'ID' },
      { field: 'processDefinitionId', title: 'processDefinitionId' },
      { field: 'processInstanceId', title: 'processInstanceId' },
      { field: 'executionId', title: 'executionId' },
      { field: 'deleteReason', title: 'deleteReason' },
      { field: 'name', title: '名称' },
      { field: 'owner', title: '所有者' },
      { field: 'assignee', title: '办理人' },
      { field: 'startTime', title: 'startTime' },
      { field: 'endTime', title: 'endTime' },
      { field: 'durationInMillis', title: 'durationInMillis' },
      { field: 'workTimeInMillis', title: 'workTimeInMillis' },
      { field: 'claimTime', title: 'claimTime' },
      {
        title: '操作',
        field: 'operation',
        fixed: 'right',
