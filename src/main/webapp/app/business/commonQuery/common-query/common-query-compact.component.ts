...
@Component
export default class CommonQueryCompactComponent extends mixins(Vue2Filters.mixin, AlertMixin) {
  ...
  public commonQueryCommonTableData: ICommonTable = null; // 实体模型数据
