<template>
    <a-card :bordered="false">
        ...
        <a-modal title="新增或编辑" :visible="updateModalVisible"
            ...
            <jhi-common-query-item-update :queryId="queryId" @cancel="updateModalCancel" :showInModal="true" :updateEntityId="commonQueryItemId" />
        </a-modal>
    </a-card>
</template>

<script lang="ts" src="./common-query-item.component.ts">
</script>
<style>
