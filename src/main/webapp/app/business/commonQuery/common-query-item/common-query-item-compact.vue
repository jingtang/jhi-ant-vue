<template>
    <a-card :bordered="false">
        ...
        <a-modal title="新增或编辑" :visible="updateModalVisible"
            ...
            <common-query-item-update :queryId="queryId"
            @cancel="updateModalCancel" :showInModal="true" :commonQueryItemId="commonQueryItemId"
            />
        </a-modal>
    </a-card>
</template>

<script lang="ts" src="./common-query-item-compact.component.ts">
</script>
<style>
