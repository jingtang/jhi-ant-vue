...
@Component
export default class CompanyCustomerComponent extends mixins(Vue2Filters.mixin, AlertMixin) {
  ...
  public editEntity(row: ICompanyCustomer): void {
