...
@Component
export default class BusinessTypeCompactComponent extends mixins(Vue2Filters.mixin, AlertMixin) {
  ...
  public removeById(removeId: number): void {
    this.businessTypeService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhiAntVueApp.companyBusinessType.deleted', { param: this.removeId }).toString();
