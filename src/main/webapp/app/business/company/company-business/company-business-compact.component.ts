...
@Component
export default class CompanyBusinessCompactComponent extends mixins(Vue2Filters.mixin, AlertMixin) {
  ...
  public companyBusinessCommonTableData: ICommonTable = null; // 实体模型数据
  ...
  newCompanyBusiness() {
    ...
    companyBusiness.id = -1;
    this.companyBusinesses.push(companyBusiness);
    this.editStatus[companyBusiness.id].edit = true;
  }
