...
export default class CommonTableRelationshipCompactComponent extends mixins(Vue2Filters.mixin, AlertMixin) {
  ...
  // 新增Article 并设置为可编辑状态
  newCommonTableRelationship() {
    const commonTableRelationship = new CommonTableRelationship();
    commonTableRelationship.id = -1;
    this.commonTableRelationships.push(commonTableRelationship);
    this.editStatus[commonTableRelationship.id].edit = true;
  }
