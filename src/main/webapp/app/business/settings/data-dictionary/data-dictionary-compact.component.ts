...
@Component
export default class DataDictionaryCompactComponent extends mixins(Vue2Filters.mixin, AlertMixin) {
  ...
  public removeById(removeId: number): void {
    this.dataDictionaryService()
      ...
      .subscribe((res: AxiosResponse) => {
        const message = this.$t('jhiAntVueApp.settingsDataDictionary.deleted', { param: this.removeId }).toString();
