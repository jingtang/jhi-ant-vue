    ...
    <div class="properties-centent kk-checkbox">
        ...
        <div class="properties-body">
            ...
            <a-form v-show="selectItem.key !== ''">
                ...
                <a-form-item
                    v-if="typeof options.labelColSpan !== 'undefined'"
                    label="标签占用栅格"
                >
                ...
                <a-form-item v-if="selectItem.type === 'modalSelect'"
                             label="数据源选项"
                >
                ...
                <a-form-item v-if="selectItem.type === 'treeSelect'"
                             label="TreeSelect配置"
                >
                ...
                >
                    ...
                    <a-input
                        v-show="options.dynamic"
                        v-model="options.valueField"
                        placeholder="value属性名"
                    >
