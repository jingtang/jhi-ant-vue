    ...
    <div class="property-panel" ref="propertyPanel">
        <a-form-model :label-col="labelCol" :wrapper-col="wrapperCol" :model="form">
            ...
            <template v-if="sequenceFlow">
                <a-form-item label="分支条件" style="margin-bottom: 5px;">
                    <a-input v-model="form.conditionExpression.body">
            ...
            handleModeler() {
                ...
                this.modeler.on("selection.changed", e => {
                    ...
                    if (this.element['type'] === 'bpmn:SequenceFlow') {
                        console.log('enter conditionExpression');
                        if (!this.form['conditionExpression']) {
                            this.form['conditionExpression'] = {'$type': '', 'body': ''};
                        }
                    }
