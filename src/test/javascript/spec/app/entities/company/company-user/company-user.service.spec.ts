...
import { CompanyUser } from '@/shared/model/company/company-user.model';
...
describe('Service Tests', () => {
  describe('CompanyUser Service', () => {
    ...
    describe('Service methods', () => {
      ...
      it('should create a CompanyUser', async () => {
      ...
      it('should update a CompanyUser', async () => {
        const returnedFromService = Object.assign({}, elemDefault);
      ...
      it('should return a list of CompanyUser', async () => {
        const returnedFromService = Object.assign({}, elemDefault);
        const expected = Object.assign({}, returnedFromService);
      ...
      it('should delete a CompanyUser', async () => {
