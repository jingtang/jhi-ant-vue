...
export default class ViewPermissionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('view-permission-heading'));
...
export class ViewPermissionDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.systemViewPermission.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-viewPermission'));
}
