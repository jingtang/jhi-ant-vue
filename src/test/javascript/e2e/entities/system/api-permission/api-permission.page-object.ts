...
export default class ApiPermissionComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('api-permission-heading'));
...
export class ApiPermissionDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.systemApiPermission.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-apiPermission'));
}
