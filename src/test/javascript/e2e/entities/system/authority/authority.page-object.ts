...
export default class AuthorityComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('authority-heading'));
...
export class AuthorityDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhiAntVueApp.systemAuthority.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-authority'));
}
