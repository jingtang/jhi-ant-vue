...
export default class CommonQueryItemComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('common-query-item-heading'));
...
export class CommonQueryItemDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.commonQueryCommonQueryItem.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-commonQueryItem'));
}
