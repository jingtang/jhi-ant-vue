...
export default class GpsInfoComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('gps-info-heading'));
...
export class GpsInfoDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.settingsGpsInfo.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-gpsInfo'));
}
