...
export default class DataDictionaryComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('data-dictionary-heading'));
...
export class DataDictionaryDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.settingsDataDictionary.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-dataDictionary'));
}
