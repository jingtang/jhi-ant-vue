...
import DataDictionaryComponentsPage, { DataDictionaryDeleteDialog } from './data-dictionary.page-object';
import DataDictionaryUpdatePage from './data-dictionary-update.page-object';
import DataDictionaryDetailsPage from './data-dictionary-details.page-object';
...
describe('DataDictionary e2e test', () => {
  let navBarPage: NavBarPage;
  let updatePage: DataDictionaryUpdatePage;
  let detailsPage: DataDictionaryDetailsPage;
  let listPage: DataDictionaryComponentsPage;
  let deleteDialog: DataDictionaryDeleteDialog;
  ...
  it('should load DataDictionaries', async () => {
    await navBarPage.getEntityPage('data-dictionary');
    listPage = new DataDictionaryComponentsPage();
  ...
  describe('Create flow', () => {
    it('should load create DataDictionary page', async () => {
      await listPage.createButton.click();
      updatePage = new DataDictionaryUpdatePage();

      await waitUntilAllDisplayed([updatePage.title, updatePage.footer, updatePage.saveButton]);

      expect(await updatePage.title.getAttribute('id')).to.match(/jhiAntVueApp.settingsDataDictionary.home.createOrEditLabel/);
    });

    it('should create and save DataDictionaries', async () => {
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        deleteDialog = new DataDictionaryDeleteDialog();
        await waitUntilDisplayed(deleteDialog.dialog);

        expect(await deleteDialog.title.getAttribute('id')).to.match(/jhiAntVueApp.settingsDataDictionary.delete.question/);
      ...
      it('should load details DataDictionary page and fetch data', async () => {
        const detailsButton = listPage.getDetailsButton(listPage.records.first());
        await click(detailsButton);

        detailsPage = new DataDictionaryDetailsPage();
      ...
      it('should load edit DataDictionary page, fetch data and update', async () => {
