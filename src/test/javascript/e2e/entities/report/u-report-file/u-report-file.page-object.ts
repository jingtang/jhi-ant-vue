...
export default class UReportFileComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('u-report-file-heading'));
...
export class UReportFileDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.reportUReportFile.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-uReportFile'));
}
