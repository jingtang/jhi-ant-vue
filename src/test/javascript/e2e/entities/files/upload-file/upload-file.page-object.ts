...
export default class UploadFileComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('upload-file-heading'));
...
export class UploadFileDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.filesUploadFile.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-uploadFile'));
}
