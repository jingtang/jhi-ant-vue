...
export default class UploadImageComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('upload-image-heading'));
...
export class UploadImageDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhiAntVueApp.filesUploadImage.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-uploadImage'));
}
