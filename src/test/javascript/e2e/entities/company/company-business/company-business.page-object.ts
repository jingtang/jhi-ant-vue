...
export default class CompanyBusinessComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('company-business-heading'));
...
export class CompanyBusinessDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.companyCompanyBusiness.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-companyBusiness'));
}
