...
export default class CompanyUserComponentsPage extends AlertPage {
...
export class CompanyUserDeleteDialog {
  ...
  title: ElementFinder = element(by.id('jhiAntVueApp.companyCompanyUser.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-companyUser'));
}
