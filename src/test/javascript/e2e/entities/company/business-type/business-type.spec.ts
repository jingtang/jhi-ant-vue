...
import BusinessTypeComponentsPage, { BusinessTypeDeleteDialog } from './business-type.page-object';
import BusinessTypeUpdatePage from './business-type-update.page-object';
import BusinessTypeDetailsPage from './business-type-details.page-object';
...
describe('BusinessType e2e test', () => {
  ...
  let updatePage: BusinessTypeUpdatePage;
  let detailsPage: BusinessTypeDetailsPage;
  let listPage: BusinessTypeComponentsPage;
  let deleteDialog: BusinessTypeDeleteDialog;
  ...
  it('should load BusinessTypes', async () => {
    await navBarPage.getEntityPage('business-type');
    listPage = new BusinessTypeComponentsPage();
  ...
  describe('Create flow', () => {
    it('should load create BusinessType page', async () => {
      ...
      updatePage = new BusinessTypeUpdatePage();

      await waitUntilAllDisplayed([updatePage.title, updatePage.footer, updatePage.saveButton]);

      expect(await updatePage.title.getAttribute('id')).to.match(/jhiAntVueApp.companyBusinessType.home.createOrEditLabel/);
    });
    ...
    describe('Details, Update, Delete flow', () => {
      after(async () => {
        ...
        deleteDialog = new BusinessTypeDeleteDialog();
        await waitUntilDisplayed(deleteDialog.dialog);

        expect(await deleteDialog.title.getAttribute('id')).to.match(/jhiAntVueApp.companyBusinessType.delete.question/);
      ...
      it('should load details BusinessType page and fetch data', async () => {
        const detailsButton = listPage.getDetailsButton(listPage.records.first());
        await click(detailsButton);

        detailsPage = new BusinessTypeDetailsPage();
      ...
      it('should load edit BusinessType page, fetch data and update', async () => {
