...
export default class CommonTableComponentsPage extends AlertPage {
  title: ElementFinder = element(by.id('common-table-heading'));
...
export class CommonTableDeleteDialog {
  dialog: ElementFinder = element(by.id('removeEntity'));
  title: ElementFinder = element(by.id('jhiAntVueApp.modelConfigCommonTable.delete.question'));
  confirmButton: ElementFinder = element(by.id('jhi-confirm-delete-commonTable'));
}
